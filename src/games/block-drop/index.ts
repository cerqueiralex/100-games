...
export const blockDropDefinition: GameDefinition = {
  ...
  mastery,
  // real-time: the player must see the stack to be ready for it to fall again
  pauseStyle: 'translucent',
  scoringNote:
    'Seven pieces fall into a ten-wide well; full rows clear. Move with the buttons, the arrow keys or by dragging on the well; tap or ↑/X to turn, Z to turn back, Space or a flick down to hard-drop, C to hold, P to pause (the well stays in view). Clear the tier’s line target to win — 10 lines on easy up to 50 on extreme — and every 10 lines raises the level and the speed. Lines pay 100 / 300 / 500 / 800 × level for 1 / 2 / 3 / 4 at once, soft drops 1 a row and hard drops 2 a row; finishing adds 500 × difficulty (1–5). Pieces come from a 7-bag, so every shape appears once per seven. No daily challenge — the bags are drawn while you play.',
  assistFeatures: [
    {
      id: 'slow',
      name: 'Slow gravity',
