...
- **Share the app**: a card in Settings that copies the app's link with one tap (and opens your phone's share sheet where it has one), next to quick how-tos for adding the app to an iPhone or Android home screen — sharing it for the first time earns the Spread the Word trophy
