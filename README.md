...
- **Player level & XP**: every 100 XP is a level. You earn 10 XP for a game played, 10 for extending your daily streak, 10 for beating your own record on a game+difficulty, 80 for beating a game on all five difficulties, and 80 for each landmark earned. A win shows exactly what it earned, and a new level gets its own card (with a sound) before the results appear. The level dial sits in the home header next to your streak and heads the profile. Its two corners carry your crowns — the rank crown you're wearing on the right, and on the left a counter for every game you've beaten on all five difficulties — and every badge you've earned sits in a case at the foot of the card, unlocked ones only, tap any one to see what it took
...
- **Progress charts** on the profile: a plays-per-category bar chart, a most-played donut and a 30-day stacked activity timeline (the last two capped to the top games, tail folded into "Other"), and a per-game improvement trend (score / win time / win % / errors). Pick a profile color and all three are redrawn as one gradient in it
